...
class Result
{
    ...
    Result(Phantom<OK> const, Args &&...args) noexcept: tag_(OK), ok_(std::forward<Args>(args)...)
    {
    }
...
class Result<void, E>
{
     ...
     * @returns a Result 'wrapping' the value given as an ok value.
     */
    static Result Ok(void) noexcept
    {
